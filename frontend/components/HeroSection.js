                ...
                <div className="space-y-4">
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <div>
                        <div className="font-semibold text-white">Advanced Signatures</div>
                        <div className="text-blue-200 text-sm">Multi-layer authentication</div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/10 rounded-lg p-4">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <div>
                        <div className="font-semibold text-white">73% Success Rate</div>
                        <div className="text-purple-200 text-sm">Proven track record</div>
                      </div>
                    </div>
                  </div>
                </div>
